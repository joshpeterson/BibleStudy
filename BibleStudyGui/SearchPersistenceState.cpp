...
SearchPersistenceState::SearchPersistenceState(QString search_string, bool match_case, bool whole_word, std::vector<QString> selected_translations) :
	...
	m_selected_translations(selected_translations)
{
	...
	QString SearchPersistenceState::serialize() const
{
